...
func processDeposits(deposits []Deposit) (gbvr *btcjson.GetBlockVerboseResult, err error) {
...
func run() error {
	...
	httpAPIAddress := flag.String("api", "127.0.0.1:6430", "http api listening address")
