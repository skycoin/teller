...
// New creates exchange service
func New(cfg Config, scanner BtcScanner, sender SkySender) *Exchange {
	return &Exchange{
		Logger:  cfg.Log,
		cfg:     cfg,
		scanner: scanner,
...
// 	case <-ec.quit:
// 		return nil
// 	case dv, ok := <-ec.scanner.GetDepositValue():
// 		if !ok {
// 			ec.Println("Scan service closed")
// 			return nil
// 		}

// 		// TODO: persist the deposit value to db, so that when restart the service
// 		// won't lost the deposit
